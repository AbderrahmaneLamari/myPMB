...
class user {
	...
	public function get_user_form($form_param_default="") {
		...
		$this->rights & ANIMATION_AUTH ? $animations_flg_form = "checked " : $animations_flg_form = "";
		...
		if(!$animations_active){
		    $message = str_replace("!!parametre!!", $msg['param_animations'].">active" , $msg['admin_disabled_module_checkbox']);
		    $animations_flg_form = 'disabled title="'.$message.'"';
		}else {
		    $animations_flg_form = "";
		    if ($this->rights & ANIMATION_AUTH) {
		        $animations_flg_form = "checked";
		    }
		}
		...
		$admin_user_form = str_replace('!!animations_flg!!', $animations_flg_form, $admin_user_form);
