...
// +-------------------------------------------------+
// $Id: serialcirc_state.class.php,v 1.11.2.1 2021/12/21 15:05:29 dgoron Exp $
...
class serialcirc_state {
	...
	public function get_filters_from_form() {
		...
		$this->perio_id = intval($serialcirc_state_perio_filter_id);
	...
	protected function get_filters_form() {
	    global $serialcirc_state_filters_form, $msg, $charset;
		global $PMBuserid;
		...
		$date_echeance_filter = "<input type='date' id='serialcirc_state_date_echeance' name='serialcirc_state_date_echeance' value='".$this->date_echeance."' />";
		...
		$filters = str_replace('!!perio_label!!', htmlentities($perio_label, ENT_QUOTES, $charset), $filters);
