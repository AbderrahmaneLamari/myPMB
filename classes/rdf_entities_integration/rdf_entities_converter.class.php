...
// +-------------------------------------------------+
// $Id: rdf_entities_converter.class.php,v 1.4.2.1 2021/09/03 08:14:42 qvarin Exp $
	        ...
	        if (pmb_mysql_num_rows($result)) {
	            while ($row = pmb_mysql_fetch_array($result)) {
	                ...
	                if (!empty($linked_entity['abstract_entity'])) {
	                    ...
	                    $object_properties['assertions'] = rdf_entities_converter_controller::convert($row[0], $type, $this->depth);
	                }
