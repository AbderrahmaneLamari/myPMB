...
class search_segment_sort {
	...
	public function get_form() {
	    ...
	    foreach ($sorts as $key => $sort) {
	        ...
	        $select_fields .= "<input id='segment_sort_name_$i' name='segment_sort_name_$i' class='saisie-30em' type='hidden' value='" . clean_string($sort_name) . "' readonly=''/>";
	        ...
	        <script type='text/javascript'>
	            ...
	            function add_sort_field(sort_index) {
                   ...
                   if(sort_index == 0 && document.getElementById('segment_sort_name_default')){
                        sort_index = 'default';
                        document.getElementById('segment_sort_name_0').value='';
                        document.getElementById('segment_sort_list_0').value='';
                        document.getElementById('segment_sort_label_0').innerHTML='';
