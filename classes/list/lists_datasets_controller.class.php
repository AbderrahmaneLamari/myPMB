...
// +-------------------------------------------------+
// $Id: lists_datasets_controller.class.php,v 1.1.2.2 2023/03/03 08:05:13 dgoron Exp $
	...
	public static function proceed($id=0) {
		...
		switch($action){
			...
			case 'play':
				...
				print "<h2>".$list_model->get_label()."</h2>";
				$list_ui_class_name = 'list_'.$list_model->get_objects_type();
				static::$list_ui_class_name = $list_ui_class_name;
				$list_ui_instance = static::get_list_ui_instance();
