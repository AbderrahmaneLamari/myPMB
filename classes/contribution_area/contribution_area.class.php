...
class contribution_area {
	...
	public function save_from_form() {
	    global $area_title, $area_comment, $area_color, $area_status, $area_repo_template_authorities, $area_repo_template_records, $area_opac_visibility, $area_logo, $area_del_logo;
		...
		$this->area_logo = stripslashes($this->get_path_area_logo($area_logo));
	}
...
// 				);
	...
	public function get_path_area_logo($logo_name) {
	    global $pmb_contribution_opac_docnum_directory;
	    
	    if ('true' == $this->area_del_logo && empty($logo_name['tmp_name'])) {
	        return '';
	    }
	    
	    $file_temp_path = $logo_name['tmp_name'];
