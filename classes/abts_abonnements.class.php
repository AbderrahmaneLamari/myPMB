...
class abts_abonnement {
	...
	public function show_form() {
		...
		if (!$this->abt_id) {
			...
			//Date de début
			if (!$this->date_debut || $this->date_debut == "0000-00-00") $date_debut=date("Y-m-d",time()); else $date_debut=$this->date_debut;
			
			$r=str_replace("!!date_debut!!", $date_debut,$r);
			...
			$r=str_replace("!!date_fin!!", $date_fin,$r);
