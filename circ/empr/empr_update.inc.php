...
if ($nberrors > 0) {
	if(preg_match("#<p>ERREUR DOUBLON LECTEUR</p>#",$error_message) && $nberrors == 1 && !$id){// Je passe ici pour la création d'un nouveau lecteur et que s'il y a une erreur de doublon
		$tab='';
		$tab->POST = $_POST;
		$tab->GET = $_GET;
