...
// +-------------------------------------------------+
// $Id: HTML5Renderer.php,v 1.1.2.11 2023/11/28 15:33:47 jparis Exp $
...
class HTML5Renderer
{
	...
	{
		if ($currentElement->viewSelected == "") {
			return "";
		}
		...
		return $viewSelected->render($itemSelected, $this->view->entityId, $viewSelected->settings->limit ?? 0, $this->view->context);
	}
