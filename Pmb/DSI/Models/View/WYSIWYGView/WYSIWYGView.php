...
// +-------------------------------------------------+
// $Id: WYSIWYGView.php,v 1.1.2.18 2023/12/01 11:29:26 rtigero Exp $
...
class WYSIWYGView extends RootView
{
	 ...
	 * @param int $idChild
	 */
	protected function updateViewChild($oldIdChild = 0, $idChild = 0)
	{
	...
	{
		foreach ($blocks as $block) {
			if ($block->type == self::BLOCK_TYPES["viewInput"] && $block->viewSelected == $viewId) {
				return $block;
			}
