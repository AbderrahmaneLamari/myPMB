...
// +-------------------------------------------------+
// $Id: ViewsController.php,v 1.20.2.18 2023/12/08 09:30:04 jparis Exp $
...
class ViewsController extends CommonController
{
     ...
     */
    public function previewView(int $idView, int $idItem, int $idEntity, int $limit, string $context)
    {
        $view = RootView::getInstance($idView);
        $item = RootItem::getInstance($idItem);
