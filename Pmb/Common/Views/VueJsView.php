...
// +-------------------------------------------------+
// $Id: VueJsView.php,v 1.9.4.2 2023/10/27 14:14:11 jparis Exp $
...
class VueJsView
{
    ...
    public function render()
    {
        ...
        $data = \encoding_normalize::json_encode($this->data) ?? '{}';
        $content .= "<script type='text/javascript'>var \$data = {$data};</script>".PHP_EOL;
