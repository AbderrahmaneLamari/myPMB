...
// +-------------------------------------------------+
// $Id: list_opac_locations_ui.class.php,v 1.1.2.4 2023/12/08 15:19:38 gneveu Exp $
    ...
    protected function get_cell_content($object, $property) {
        ...
        switch($property) {
            case 'libelle':
				...
				<br />
                <a href='".$base_path."/index.php?lvl=section_see&location=".$object->id.$url_extra."'><b>".$object->libelle."</b></a>";
                break;
            default :
