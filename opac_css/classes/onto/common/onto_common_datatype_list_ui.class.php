...
// +-------------------------------------------------+
// $Id: onto_common_datatype_list_ui.class.php,v 1.19.2.3 2022/01/18 09:40:49 gneveu Exp $
...
class onto_common_datatype_list_ui extends onto_common_datatype_ui {
	...
	public static function get_selector_form($item_uri, $property, $restrictions, $datas, $options_values) {
		...
		$lang = !empty($datas[0]) ? $datas[0]->get_lang() : "";
		$inside_row = str_replace("!!onto_row_content_list_lang!!", $lang, $inside_row);
