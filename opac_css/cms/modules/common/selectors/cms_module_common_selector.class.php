...
class cms_module_common_selector extends cms_module_root{
	...
	public function get_human_description(){
		$description="<span class = '".$this->class_name."_human_description'>";
		if(method_exists($this,'get_human_description_selector')){
			$description .= $this->get_human_description_selector();
		}else{
