	...
	if ($result && pmb_mysql_num_rows($result)) {
		if ($explnum = pmb_mysql_fetch_object($result)) {
			...
			$obj.="$statut_libelle_div
				<a  href='#' onmouseout=\"z=document.getElementById('zoom_statut_docnum".$explnum->explnum_id."'); z.style.display='none'; \" onmouseover=\"z=document.getElementById('zoom_statut_docnum".$explnum->explnum_id."'); z.style.display=''; \">
					<div class='vignette_doc_num' ><img $class_img width='10' height='10' src='".get_url_icon('spacer.gif')."'></div>
				</a>
			";
