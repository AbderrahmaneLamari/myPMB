...
export default {
    ...
    methods: {
        ...
        getViewTypeNameById: function(idViewType) {
            ...
            return this.viewTypes.find(t => t.id === idViewType).name;
        },
        ...
        getViewModelImg: function(viewModel) {
            ...
            const viewType = this.viewTypes.find((viewType) => viewType.id == viewModel.type);
            if(viewType && viewType.default_model_image) {
                return viewType.default_model_image;
            }
