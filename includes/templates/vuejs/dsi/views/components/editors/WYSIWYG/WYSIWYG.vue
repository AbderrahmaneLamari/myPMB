	    ...
	    <form class="wysiwyg-form-view" ref="wysiwyg_form">
	        <div v-if="! showPreview" class="wysiwyg-form-view-buttons">
	            <div class="wysiwyg-form-view-buttons-left">
	                ...
	                <button type="button" class="wysiwyg-button" @click="getPreview" :disabled="showPrev || !idDiffusion" :title="messages.get('dsi', 'view_wysiwyg_preview')">
	        ...
	        <div v-else-if="showTree" class="wysiwyg-tree">
	            <tree :tree="view.settings.layer.blocks[0]" :blockLabels="blockLabels"></tree>
	        </div>
	...
	export default {
        ...
        created: function() {
            ...
            this.$root.$on('removeBlock', (data) => {
                if (this.view.id == data.parent.id) {
        ...
        computed: {
            previewUrl: function() {
                ...
                return "rest.php/dsi/diffusions/preview/" + this.idDiffusion + "/" + selectedAttachment;
            },
