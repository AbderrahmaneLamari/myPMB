            ...
            <lockable :locked="subscriberList.source.settings.locked">
                <div style="display:grid;">
                    <div id="dsi-diffusion-aside" style="grid-column-start : 1; grid-column-end:2; padding-right: 1rem;">
                        ...
                        <subscriber-source v-if="sources.length" :from="Const.subscriberlist.from.source" :subscriber-list="subscriberList.source" :sources="sources"></subscriber-source>
                    </div>
            ...
            <div class='row dsi-form-action'>
                <div class="left">
                    <template v-if="modelForm">
                        ...
                        <input name="submit_model" type="button" class="bouton" @click.prevent="submitSubscriberList($event.target)" :value="messages.get('dsi', 'submit_model')">
                    </template>
