...
<tr class='!!pair_impair!!' onmouseover=\"this.className='surbrillance'\" onmouseout=\"this.className='!!pair_impair!!'\" style='cursor: pointer'>
	<td class='sort' style='width:90%' alt='".$msg['appliq_tri']."' title='".$msg['appliq_tri']."' 
        data-sort_link='./recall.php?current=" . (isset($_SESSION["CURRENT"]) ? $_SESSION["CURRENT"] : '') . "&t=!!t!!&tri=!!id_tri!!&reference=!!reference!!&type_tri=!!type_tri!!&ajax=1&module=$current_module'>
		!!nom_tri!!
	</td>
	<td style='width:5%'>
...
$ligne_tableau_tris = "
<tr class='!!pair_impair!!' onmouseover=\"this.className='surbrillance'\" onmouseout=\"this.className='!!pair_impair!!'\" style='cursor: pointer'>
	<td style='width:90%' alt='".$msg['appliq_tri']."' title='".$msg['appliq_tri']."' onClick='parent.document.getElementById(\"history\").style.display=\"none\";parent.location.href=\"./recall.php?current=" . (isset($_SESSION["CURRENT"]) ? $_SESSION["CURRENT"] : '') . "&t=!!t!!&tri=!!id_tri!!&reference=!!reference!!&type_tri=!!type_tri!!&module=$current_module\"; return false;'>
			!!nom_tri!!
	</td>
	<td style='width:5%'>
			<a href='#' onClick='agitTri(\"modif\",!!id_tri!!);'>
...
$ligne_tableau_tris_segment = "
<tr class='!!pair_impair!!' onmouseover=\"this.className='surbrillance'\" onmouseout=\"this.className='!!pair_impair!!'\" style='cursor: pointer'>
	<td style='width:90%' alt='".$msg['appliq_tri']."' title='".$msg['appliq_tri']."' onClick='defineSort(\"modif\", \"!!segment_id!!\")' >
			!!nom_tri!!
	</td>
	<!--<td style='width:5%'>
			<a href='#' onClick='agitTri(\"modif\",!!id_tri!!);'>
...
$popup_ligne_tableau_tris_segment = "
<tr class='!!pair_impair!!' onmouseover=\"this.className='surbrillance'\" onmouseout=\"this.className='!!pair_impair!!'\" style='cursor: pointer'>
	<td class='sort' style='width:90%' alt='".$msg['appliq_tri']."' title='".$msg['appliq_tri']."' onClick='defineSort(\"modif\", \"!!segment_id!!\")'>
		!!nom_tri!!
	</td>
	<!--<td style='width:5%'>
		<a href='#' onClick='agitTri(\"modif\",!!id_tri!!);'>
...
<tr class='!!pair_impair!!' onmouseover=\"this.className='surbrillance'\" onmouseout=\"this.className='!!pair_impair!!'\" style='cursor: pointer'>
	<td style='width:90%' alt='".$msg['appliq_tri']."' title='".$msg['appliq_tri']."' onClick='parent.document.getElementById(\"history\").style.display=\"none\";parent.location.href=\"./recall.php?current=" . (isset($_SESSION["CURRENT"]) ? $_SESSION["CURRENT"] : '') . "&t=!!t!!&tri=!!id_tri!!&external=1&reference=!!reference!!&type_tri=!!type_tri!!&module=$current_module\"; return false;'>
			!!nom_tri!!
	</td>
	<td style='width:5%'>
			<a href='#' onClick='agitTri(\"modif\",!!id_tri!!);'>
...
$show_sel_form_segments = " <body class='$current_module' onLoad='document.forms[\"sort_form\"].elements[\"nom_tri\"].focus();'>
	...
	<table style='width:100%'><tr><td class='align_left'><h3>".$msg['definir_tri']."</h3></td>".(!empty($popup) && $popup ? $close_btn : "")."</tr></table>
		<form name='sort_form' method='post' action='sort.php?categ=search_universes&num_segment=!!id_segment!!'>
		   <table style='width:100%; height:100%'>
				<tr>
					<td colspan=3>".$msg['nom_tri']."&nbsp;&nbsp;<input type='text' name='nom_tri' value='!!nom_tri!!'><input type=hidden name='id_tri' value='!!id_tri!!'>
					</td>
