...
<form class='form-".$current_module."' id='!!form_name!!' name='!!form_name!!' method='post' action=\"!!action!!\" >
	...
	<div class='form-contenu'>
		<div id='!!objects_type!!_search_label' class='list_ui_search_label !!objects_type!!_search_label' style='display:!!unfoldable_filters!!;'>
			<img src='!!expandable_icon!!' class='img_plus' name='imEx' id='!!objects_type!!_search_img' title='".$msg['plus_detail']."' border='0' hspace='3'>
...
$list_ui_settings_content_form_tpl = "
		...
		<div id='!!objects_type!!_settings_label' class='list_ui_settings_label !!objects_type!!_settings_label'>
			<img src='".get_url_icon('plus.gif')."' class='img_plus' name='imEx' id='!!objects_type!!_settings_img' title='".$msg['plus_detail']."' border='0' hspace='3'>
...
<div class='row'>
	<div class='list_ui_settings_display_label'>
		<img src='".get_url_icon('plus.gif')."' class='img_plus' name='imEx' id='!!objects_type!!_settings_display_img' title='".$msg['plus_detail']."' border='0' hspace='3'>
...
<div class='row'>
	<div class='list_ui_settings_columns_label'>
		<img src='".get_url_icon('plus.gif')."' class='img_plus' name='imEx' id='!!objects_type!!_settings_columns_img' title='".$msg['plus_detail']."' border='0' hspace='3'>
	...
	<div id='!!objects_type!!_settings_columns_content' class='list_ui_settings_columns_content !!objects_type!!_settings_columns_content'>
 		<table>
			<tr>
				<th>".htmlentities($msg['list_ui_settings_columns_label'], ENT_QUOTES, $charset)."</th>
				<th>".htmlentities($msg['list_ui_settings_columns_align'], ENT_QUOTES, $charset)."</th>
				<th>".htmlentities($msg['list_ui_settings_columns_text'], ENT_QUOTES, $charset)."</th>
			<!--
				<th>".htmlentities($msg['list_ui_settings_columns_text_color'], ENT_QUOTES, $charset)."</th>
				<th>".htmlentities($msg['list_ui_settings_columns_level'], ENT_QUOTES, $charset)."</th>
			-->
...
<div class='row'>
	<div class='list_ui_settings_filters_label'>
		<img src='".get_url_icon('plus.gif')."' class='img_plus' name='imEx' id='!!objects_type!!_settings_filters_img' title='".$msg['plus_detail']."' border='0' hspace='3'>
	...
	<div id='!!objects_type!!_settings_filters_content' class='list_ui_settings_filters_content !!objects_type!!_settings_filters_content'>
 		<table>
			<tr>
				<th>".htmlentities($msg['list_ui_settings_filters_label'], ENT_QUOTES, $charset)."</th>
				<th>".htmlentities($msg['list_ui_settings_filters_visible'], ENT_QUOTES, $charset)."</th>
				<th>".htmlentities($msg['list_ui_settings_filters_selection_type'], ENT_QUOTES, $charset)."</th>
			</tr>
			!!settings_filters!!
		</table>
	</div>
...
<div class='row'>
	<div class='list_ui_settings_selection_actions_label'>
		<img src='".get_url_icon('plus.gif')."' class='img_plus' name='imEx' id='!!objects_type!!_settings_selection_actions_img' title='".$msg['plus_detail']."' border='0' hspace='3'>
	...
	<div id='!!objects_type!!_settings_selection_actions_content' class='list_ui_settings_selection_actions_content !!objects_type!!_settings_selection_actions_content'>
 		<table>
			<tr>
				<th>".htmlentities($msg['list_ui_settings_selection_actions_label'], ENT_QUOTES, $charset)."</th>
				<th>".htmlentities($msg['list_ui_settings_selection_actions_visible'], ENT_QUOTES, $charset)."</th>
			</tr>
