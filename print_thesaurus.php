...
if ($action != "print") {
	...
	print "\n</select>
		...
		<blockquote>
			...
			<input type='checkbox' name='aff_no_trad' value='1'/>&nbsp;".$msg['print_thes_no_trad']."<br />
			<input type='checkbox' name='aff_num_aut' value='1'/>&nbsp;".$msg['print_thes_num_aut']."<br />
			<input type='checkbox' name='aff_tg_num_aut' value='1'/>&nbsp;".$msg['print_thes_tg_num_aut']."
		</blockquote>
...
function creer_categ_xml($dom,$parent,$niveau, $num_noeud,$libelle_categorie,$note_application,$comment_public,$num_parent, $autorite,$not_use_in_indexation=0){
	global $aff_langue;
	global $aff_note_application, $aff_commentaire, $aff_voir, $aff_voir_aussi, $aff_tg, $aff_ts, $aff_num_aut;
	global $msg;
